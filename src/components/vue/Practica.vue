  ...
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
    ...
    <div class="space-y-4 w-full max-w-md">
      <div
        ...
        :key="correo.id"
        class="bg-white p-4 flex flex-col items-start cursor-pointer rounded-lg shadow-md"
        :class="{
...
const correos = ref([
  { id: 'correo1', titulo: 'Correo 1', texto: 'Texto del correo 1', tiempo: 'Hace 1 hora', leido: false, selected: false, hovered: false },
  { id: 'correo2', titulo: 'Correo 2', texto: 'Texto del correo 2', tiempo: 'Hace 1 hora', leido: false, selected: false, hovered: false },
  { id: 'correo3', titulo: 'Correo 3', texto: 'Texto del correo 3', tiempo: 'Hace 2 horas', leido: false, selected: false, hovered: false },
  { id: 'correo4', titulo: 'Correo 4', texto: 'Texto del correo 4', tiempo: 'Ayer', leido: false, selected: false, hovered: false },
]);
